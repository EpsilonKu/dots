...
awful.keyboard.append_global_keybindings({
	awful.key({ modkey }, "#25"--[[ w ]] , awful.tag.viewprev,
		{ description = "view previous", group = "tag" }),
	awful.key({ modkey }, "#39"--[[ s ]] , awful.tag.viewnext,
		{ description = "view next", group = "tag" }),
	awful.key({ modkey }, "#40"--[[ d ]] , function() awful.client.focus.byidx(1) end,
		{ description = "focus next by index", group = "client" }),
	awful.key({ modkey }, "#38"--[[ a ]] , function() awful.client.focus.byidx(-1) end,
		{ description = "focus previous by index", group = "client" }),
	awful.key({ modkey }, "e", function() awful.spawn(launcher) end,
...
-- Layout Machi TODO: Config Machi
-- awful.keyboard.append_global_keybindings(
--     {
--         awful.key(
--             {modkey},
...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ modkey }, "b", function() awful.spawn("dm-tool lock") end,
		{ description = "open a terminal", group = "launcher" }),
	-- awful.key({modkey}, "s",
	...
	awful.key({ modkey, "Control" }, "w",
		...
		{ description = "set max layout", group = "tag" }), -- awful.key(
	--     {modkey},
	--     "s",
	--     function()
