...
awesome_icon_container:connect_signal("button::press", function()
  ...
  awesome_icon.top = dpi(13)
  awesome_icon.left = dpi(13)
  awesome_icon.right = dpi(11)
  awesome_icon.bottom = dpi(11)
end)

awesome_icon_container:connect_signal("button::release", function()
  awesome_icon.margins = dpi(12)
...
local notif_icon = wibox.widget {
  ...
  margins = { top = dpi(10), bottom = dpi(10), left = dpi(12), right = dpi(12) },
  widget = wibox.container.margin
}
...
notif_icon_container:connect_signal("button::release", function()
  notif_popup.widget = wibox.widget {
    -- require("ui.notifs.notif-center")(awful.screen.focused()),
    margins = dpi(20),
    widget = wibox.container.margin
  }
...
battery_bar_container:connect_signal("button::release", function()
  battery_popup.screen = awful.screen.focused()
...
screen.connect_signal("request::desktop_decoration", function(s)
  ...
  s.mytaglist = require("ui.widgets.rubato-taglist")(s)

  -- Create the tasklist widget
  s.mytasklist = require("ui.widgets.tasklist")(s)
